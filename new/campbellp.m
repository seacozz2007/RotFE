...
if strcmp(FILE, 'go' ),
  ...
  %    d=eigs((aa),'SM',20); 						% compute eigevalues
   ...
   set(gcf,'name','campbellp Diagram')
...
elseif strcmp(FILE,'init') , % init
   ...
   uicontrol('style','edit',...
      ...
      'pos',[.55 .19+dy .15 .08],...
      'tag',[toolname 'file'],...
      'callback','FILE=get(findobj(gcf,''tag'',''campbellpfile''),''string'');drawrot(FILE);axis auto',...
      'backgroundcolor','w');
   uicontrol('style','text',...
