...
% by: I. Bucher 16-Feb-2002
 ...
 N_NODES=length(NODES);      
  ...
  NODES=[linspace(0,3*1.46,30) ] ;                                                              
 N_NODES1=length(NODES);      
...
% SPRINGS=[node1 Kxx1 Kyy1 Kxy1 Kyx1 Ktt1 Kpp1 Ktp1 Kpt1   % bearing #1                         
 ...
 BCNodeDir=[1+[1:4]/10 N_NODES*[1:3]+.1 N_NODES*[1:3]+.3   ]';

  UNBALANCE=[2 1e-3 0];

  POINT_MASS = [ 1  1.0 2e-2 1.6e-2
                N_NODES 1.0 2e-2  1.6e-2
                2*N_NODES 1.0 2e-2  1.6e-2
                3*N_NODES 1.0 2e-2  1.6e-2
            ];
