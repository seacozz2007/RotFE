...
%====================================================================================           
 ...
 DISCS=[ N_NODES 0.2 	15e-3 10e-3 1                                                                     
 		 ];                                                                         
...
%====================================================================================           
  ...
  SPRINGS=[	1 1e5 	3e5   % the missing entries, e.g. Kxy etc.                                     
    		fix(N_NODES/2) 2e5 	2e5];   % are assumed to be zero                                                     
 %SPRINGS=[];
...
RNodeDir=[N_NODES-2+.1;N_NODES-2+0.3  ];
